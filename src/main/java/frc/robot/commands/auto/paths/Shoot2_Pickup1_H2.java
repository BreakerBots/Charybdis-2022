...
public class Shoot2_Pickup1_H2 extends SequentialCommandGroup {
    /** Creates a new Pickup2_Shoot3_P2. */
    public Shoot2_Pickup1_H2(Drive driveArg, IMU imuArg, Intake intakeArg, Hopper hopperArg, XboxController controllerArg, Shooter shooterArg) {
      ...
      addCommands(
       ...
       new DriveStraight(driveArg, imuArg, 55, 0.4, 2.5),
       new DriveStraight(driveArg, imuArg, -55, 0.4, 2.5),
       new ToggleIntake(intakeArg, hopperArg),
       new DrivePivot(driveArg, imuArg, -35, 0.2),
       new DriveStraight(driveArg, imuArg, -30, 0.4, 2.5),
